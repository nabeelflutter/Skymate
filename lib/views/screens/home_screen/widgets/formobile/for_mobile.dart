...
class ForMobileDesignHomePage extends StatefulWidget {
  ...
  @override
  State<ForMobileDesignHomePage> createState() => _ForMobileDesignHomePageState();
}
                  ...
                  child:  Container(
                    ...
                    child: Center(
                      child: Column(
                        ...
                        children: [
                          Text('The net work that gets you',style: TextStyle(  fontFamily: 'Chusion',fontSize: 16,fontWeight: FontWeight.bold,color: Constants.whight),),
                          Text('In publishing and graphic design',style: TextStyle(  fontFamily: 'Chusion',fontSize: 12,color: Constants.whight),),
                        ],
                      ),
                    ),
                  ),
                  ...
                  child: Center(
                    child: TextFormField(
                      decoration:  InputDecoration(
                        hintText: _departureDateController.text.toString(),
              ...
              child: CardWithShadowOnHover(
                child: Card(
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        border: Border.all(color: Colors.grey),
                        borderRadius: BorderRadius.circular(4),image: const DecorationImage(image: AssetImage('assets/images/g2.jpg'),fit: BoxFit.fill)
                    ),
